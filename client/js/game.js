...
function(InfoManager, BubbleManager, Renderer, Map, Animation, Sprite, AnimatedTile,
    ...
    var Game = Class.extend({
        init: function(app) {
            ...
            window.gametypes = this.gametypes;
            this.app = app;
            ...
            this.jscontrol = window.jscontrol;
            window.game = this;
        ...
        initPlayer: function() {
            if(this.storage.hasAlreadyPlayed()) {
                ...
                if(this.storage.data.player.skin !=""){
                    this.player.switchSkin(this.storage.data.player.skin);
                }
            }
            else{
                if(window.skin != "" && window.skin != undefined){
                    console.log("loading window skin ", window.skin);
                    this.player.switchSkin(window.skin);
                }
            }
        ...
        connect: function(started_callback) {
            ...
            this.client.onWelcome(function(id, name, x, y, hp) {
                ...
                self.client.onSpawnCharacter(function(entity, x, y, orientation, targetId,skin) {
        ...
        getMouseGridPosition: function() {
            var mx = this.mouse.x,
                ...
                ts = this.renderer.tilesize*this.renderer.scale,

                gridX = Math.floor(mx / ts) + c.gridX,
                gridY = Math.floor(my / ts) + c.gridY;
        ...
        showNotification: function(message) {
            window.ChatLog.addMessage(message);
